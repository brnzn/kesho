...
CREATE TABLE `CONTACT_DETAIL` (
  ...
  PRIMARY KEY (`ID`),
  KEY `CONTACT_DETAIL_CONTACT_FK` (`OWNER_ID`)
...
) ENGINE=InnoDB AUTO_INCREMENT=20413 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4331 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SPONSORS` (
  ...
  `VERSION` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=10268 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `STUDENTS` (
  ...
  `END_DATE` date DEFAULT NULL,
  `FINANCIAL_SUPPORT_STATUS_SUB_DETAILS` varchar(45) DEFAULT NULL,
  `VERSION` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `FAMILY_STUDENT_FK` (`FAMILY_ID`),
  CONSTRAINT `FAMILY_STUDENT_FK` FOREIGN KEY (`FAMILY_ID`) REFERENCES `FAMILY` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=10544 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-10-06 18:00:45
