...
) ENGINE=InnoDB AUTO_INCREMENT=13633 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `FAMILY` (
  ...
  `NUM_NON_KESHO_STUDENTS_AT_ADDRS` tinyint(1) DEFAULT NULL,
  `NUM_OF_WIVES` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `FAMILY_NAME_UNIQUE` (`FAMILY_NAME`)
) ENGINE=InnoDB AUTO_INCREMENT=6614 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=73347 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-06-09 21:40:15
